        ...
        <>
            <Sheet>
                <div className="flex items-center text-center absolute w-full h-14 z-40 left-1/2 -translate-x-1/2 justify-between top-8 container max-w-6xl mx-auto">
                    ...
                    <div className="rsvp animate-spin animate-infinite animate-duration-[5000ms] animate-ease-linear animate-normal animate-fill-backwards">
                        <Button className='text-[--bg-footer] text-xl font-semibold rounded-full w-20 h-20 bg-[--primary] hover:bg-[--primary]' variant={'default'}>
                            RSVP
                        </Button>
                    </div>
                </div>
                <SheetContent className="bg-[--primary] sm:max-w-full w-full">
                    <div className="container max-w-7xl  mt-8">
                        <div className="header flex w-full my-10 justify-between">
                            <SheetClose>
                            ...
                            <div className="logo_dark w-44 h-20">
                            ...
                            <div className="rsvp animate-spin animate-infinite animate-duration-[5000ms] animate-ease-linear animate-normal animate-fill-backwards">
                                <Button className='text-[--primary] text-xl font-semibold rounded-full w-20 h-20 bg-[--bg-footer] hover:bg-[--bg-footer]' variant={'default'}>
                                    RSVP
                                </Button>
                            </div>
                        </div>
